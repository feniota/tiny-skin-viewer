/** Properties accepted by the SkinViewer component. */
export interface SkinViewerProps {
   ...
   *
   * @default "https://assets.ferris.love/phenocryst/steve.png"
   */
  skinUrl?: string;
   ...
   *
   * - `true` = **Slim** (Alex / 3px wide arms)
   * - `false` = **Classic** (Steve / 4px wide arms)
   *
   * @default false
   */
  isSlim?: boolean;
   ...
   * Minecraft cape textures are 64×32px. Leave falsy to disable cape rendering.
   *
   * @default undefined
   */
  capeUrl?: string | null;
  ...
  /**
   * Animation time override in seconds.
   *
   * When set, drives all animations from this value instead of the
